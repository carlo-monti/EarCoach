...
public class Words {
    ...
    public static String ELECTRIC_GUITAR;
    ...
    static void generateStaticVariablesFromResources(Context context){
        ...
        ELECTRIC_GUITAR = context.getString(R.string.ELECTRIC_GUITAR);
        CLASSICAL_GUITAR = context.getString(R.string.CLASSICAL_GUITAR);
        HARMONICA = context.getString(R.string.HARMONICA);
    ...
    static String get(int stringID){
        return mainContext.getResources().getString(stringID);
    }
